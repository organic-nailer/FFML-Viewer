                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  _pcapManager?.dispose();
                                  _pcapManager =
                                      PcapManager(tempDir.path, maxPointNum);
                                  selectedFrame = 0;
                                  _pcapManager!.addListener(() async {
                                    if (_pcapManager!.length > 0 &&
                                        _dataSource.rowCount == 0) {
                                      final frame = await _pcapManager!
                                          .getFrame(0, filter: filterNotifier.filter);
                                      if (frame == null) {
                              ...
                              Expanded(
                                child: PcdSlider(
                                    ...
                                    onSelectedFrameChanged: (value) async {
                                      ...
                                      selectedFrame = value;
                                      final frame = await _pcapManager!
                                          .getFrame(value, filter: filterNotifier.filter);
                                      if (frame == null) {
